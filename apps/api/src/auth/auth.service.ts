...
export class AuthService {
  ...
  async login(loginDto: LoginDto): Promise<AuthTokens> {
    ...
    return this.tokens.signTokens(user.id, user.tokenVersion);
  }
  ...
  async forgotPassword(
    ...
    return this.passwordReset.forgotPassword(dto.email, normalizedEmail);
  }
  ...
  async logout(userId: string): Promise<void> {
    await this.tokens.revokeUserTokens(userId);
  }
